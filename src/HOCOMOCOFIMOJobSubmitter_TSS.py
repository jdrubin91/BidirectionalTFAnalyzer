...
if __name__ == "__main__":
    ...
    for item in motiflist:
        if not os.path.exists(shellscripttemplatedir + "/FIMO_OUT_TSS/" + item + "_fimo_out"):
    ...
    for motif in motiflist1:
        os.system("qsub -v arg1='/scratch/Shares/dowell/ENCODE/HOCOMOCODatabaseFIMO/FIMO_OUT_TSS/" + motif + "_fimo_out',arg2='" + motif + "' runHOCOMOCO_TSS_FIMOTemplate.sh")
        if i%100 == 0:
            time.sleep(12600)
        i+=1
