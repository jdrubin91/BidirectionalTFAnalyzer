...
def run(bidirfile, chipfile, fimofile, outdir,dnasefile):
    ...
    return chiptot, chipbidir, chipfimo, chipbidirfimo, bidirfimo, bidirfimochip, fimochip, fimotot, fimochipbidir,bidirchip, bidirtot,dnachip,dnafimo,dnatot,dnachipfimobidir,dnachipfimo,dnafimobidir
...
if __name__ == "__main__":
            ...
            if len([i for i in os.listdir(chipdir + '/' + TF + '/peak_files') if 'bed' in i]) != 0:
                ...
                for fimoTF in os.listdir(fimodir):
                    if TF == fimoTF.split('_')[0]:
                        ...
                        chiptot, chipbidir, chipfimo, chipbidirfimo,bidirfimo,bidirfimochip,fimochip,fimotot,fimochipbidir,bidirchip, bidirtot,dnachip,dnafimo,dnatot,dnachipfimobidir,dnachipfimo,dnafimobidir = run(bidirfile,chipfile,fimofile,chipdir + '/' + TF,dnasefile)
                        ...
                        list4[0].append(dnachip/chiptot)
    ...
    ax4.boxplot(list4)
    ax4.set_xticklabels(['DNAse-Chip/Chip','DNAse-Chip-Mot/DNAse-Mot','DNAse-Chip-Mot-Bid/DNAse-Mot-Bid'],rotation = 45, fontsize=8)
    #ax = plt.axes()
    #plt.boxplot(list1)
